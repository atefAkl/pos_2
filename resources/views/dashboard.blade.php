        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="alert alert-success">
                    <strong>نقطة البيع مفتوحة</strong> - الرصيد الافتتاحي:
                    {{ number_format($openSession->opening_balance, 2) }} جنيه
                    <form action="{{ route('pos-sessions.close') }}" method="POST" class="d-inline float-start">
                        @csrf
                        <div class="row g-2">
                            <div class="col-auto">
                                <input type="number" step="0.01" class="form-control form-control-sm"
                                    name="closing_balance" placeholder="الرصيد الختامي" required>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-md-12">
                <div class="alert alert-warning">
                    ...
                    <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal"
                        data-bs-target="#openShiftModal">فتح نقطة البيع</button>
                </div>
            </div>
        </div>
    @endif
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="shift_name" name="name"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control" id="opening_balance"
                                    name="opening_balance" value="0" required>
                            </div>
                            <div class="col-md-6">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <a href="{{ route('staff.members.index') }}" class="setting-link col-12 col-sm-6 col-md-4 col-lg-3">
                    <i class="fa fa-print fa-2x"></i>
                    <span class="link-title fs-6" style="">اجهزة الكاشير</span>
                </a>
            </div>
